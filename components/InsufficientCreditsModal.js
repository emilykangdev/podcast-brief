...
export default function InsufficientCreditsModal({ isOpen, onClose, creditData }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-base-100 rounded-lg p-6 max-w-sm w-full mx-4 space-y-4">
        ...
        <p className="text-sm text-base-content/70">
          {creditData?.message || `You need ${creditData?.creditsNeeded ?? "more"} credits but have ${creditData?.creditsRemaining ?? 0}.`}
        </p>
