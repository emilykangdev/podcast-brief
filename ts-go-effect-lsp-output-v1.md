...
- TypeScript Go repository (official Microsoft project)
- Effect TS Go repository (Effect organization on GitHub)
- OXCLint (type-aware linting tool referenced as architectural inspiration)
- VTSLS (TypeScript language server used by Neovim)
- Effect Schema (for JSON operations)
- Effect v3 and Effect v4
- JSON Placeholder (example service used in demo)
